...
public class student_result extends JFrame {
	...
	public void displayresultforstudent() {
	    DefaultTableModel resultstudentModel = (DefaultTableModel)studentResultTable.getModel();
	    resultstudentModel.setRowCount(0); // Clear existing rows
	    ...
	    try (Connection connection = DriverManager.getConnection(url, username, password)) {
	        ...
	        try (Statement statement = connection.createStatement();
	            ...
	            while (resultSet.next()) {
	                ...
	                resultstudentModel.addRow(data);
                ...
                try (Connection connection = DriverManager.getConnection(url, username, password)) {
                    ...
                    try (Statement statement = connection.createStatement();
                        ...
                        while (resultSet.next()) {
                            ...
                            String marks = resultSet.getString(7);
                            String[] data = {id, firstname, lastname, email, module, CourseName, marks};
                            model.addRow(data); // Add each row to the table
                        }
                    }
