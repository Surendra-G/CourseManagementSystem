...
public class for_teacher extends JFrame {
	...
	private JTable forteachertable;
	...
	public static void main(String[] args) {
	 ...
	 public void displayteachertableInfo() {
	        DefaultTableModel forteachertableInfo = (DefaultTableModel) forteachertable.getModel();
	        forteachertableInfo.setRowCount(0); // Clear existing rows
	        ...
	        try (Connection connection = DriverManager.getConnection(url, username, password)) {
	            ...
	            try (Statement statement = connection.createStatement();
	                ...
	                while (resultSet.next()) {
	                    ...
	                    forteachertableInfo.addRow(data);
	...
	public for_teacher() {
     ...
     // Side Panel
        ...
        teacher_add_btn.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
     	        ...
     	        try (Connection connection = DriverManager.getConnection(url, username, password)) {
     	            try (Statement statement = connection.createStatement();
     	                 ResultSet resultSet = statement.executeQuery(query)) {
     	                DefaultTableModel model = (DefaultTableModel) forteachertable.getModel();
        ...
        forteachertable = new JTable();
        scrollPane.setViewportView(forteachertable);
        forteachertable.setModel(new DefaultTableModel(
        	new Object[][] {
        	},
        	new String[] {
